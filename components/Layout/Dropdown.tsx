...
export const Dropdown = ({
  ...
  return (
    <Menu as="div" className="relative inline-block text-left z-[999]">
      ...
      >
        <Menu.Items className="absolute right-0 mt-2 w-56 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none z-[999] ">
          <div className="py-1">
            {items.map((item) => (
              <Menu.Item>
                {({ active }) => (
